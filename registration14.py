...
def createSpreadSheetData():
    spreadsheet = []
    for county in counties:
        scrapedNameList = readTxtFile(county) #tallies up important things and returns a dict row- Year, VD, County
        summarized = createDemoSummary(scrapedNameList)
...
def writeSheet(spreadsheet):
    workbook = xlsxwriter.Workbook('2014-Registered Voters.xlsx')
